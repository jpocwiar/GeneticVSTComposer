...
public:
  ...
  Diatonic(const std::string &note_, const std::vector<int> &semitones_,
           const int octaves_ = 1);
...
public:
  ...
  // Create the Bachian (also known as "real melodic minor" and "jazz") scale
...
public:
  ...
  // Create the octatonic (also known as "diminished") scale starting on the
  // chosen note.
